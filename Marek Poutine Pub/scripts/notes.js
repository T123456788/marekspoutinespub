...
const courseName="Web Design for Beginnings";
...
function timeGreeting (){
    // I want this function to give the proper greeting for the curreent time of day
    let date= new Date();
   console.log(date);
...
function forTimeTable(multiplier , limit){
